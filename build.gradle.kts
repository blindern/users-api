...
dependencies {
  ...
  implementation("org.http4k:http4k-core:5.25.0.0")
  implementation("org.http4k:http4k-server-jetty:5.25.0.0")
  implementation("org.http4k:http4k-format-moshi:5.25.0.0")
...
tasks.register("dockerBuildProperties") {
  ...
  outputs.file("${layout.buildDirectory}/build.properties")

  doLast {
    File("${layout.buildDirectory}/build.properties").bufferedWriter().use {
