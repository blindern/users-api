...
dependencies {
  ...
  implementation("org.http4k:http4k-core:3.273.0")
  implementation("org.http4k:http4k-server-jetty:3.273.0")
  implementation("org.http4k:http4k-format-moshi:3.273.0")
