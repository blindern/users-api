...
dependencies {
  ...
  implementation("org.http4k:http4k-core:5.37.1.0")
  implementation("org.http4k:http4k-server-jetty:5.37.1.0")
  implementation("org.http4k:http4k-format-moshi:5.37.1.0")
