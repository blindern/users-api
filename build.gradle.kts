...
dependencies {
  ...
  implementation("org.http4k:http4k-core:6.9.0.0")
  implementation("org.http4k:http4k-server-jetty:6.9.0.0")
  implementation("org.http4k:http4k-format-moshi:6.9.0.0")
