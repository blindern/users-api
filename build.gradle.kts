...
dependencies {
  ...
  implementation("org.http4k:http4k-core:4.30.9.0")
  implementation("org.http4k:http4k-server-jetty:4.30.9.0")
  implementation("org.http4k:http4k-format-moshi:4.30.9.0")
