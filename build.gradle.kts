...
dependencies {
  ...
  implementation("org.http4k:http4k-core:4.3.5.4")
  implementation("org.http4k:http4k-server-jetty:4.3.5.4")
  implementation("org.http4k:http4k-format-moshi:4.3.5.4")
