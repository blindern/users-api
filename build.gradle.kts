...
dependencies {
  ...
  implementation("org.http4k:http4k-core:4.43.1.0")
  implementation("org.http4k:http4k-server-jetty:4.43.1.0")
  implementation("org.http4k:http4k-format-moshi:4.43.1.0")
