...
dependencies {
  ...
  implementation("org.http4k:http4k-core:4.35.0.0")
  implementation("org.http4k:http4k-server-jetty:4.35.0.0")
  implementation("org.http4k:http4k-format-moshi:4.35.0.0")
