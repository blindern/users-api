...
dependencies {
  ...
  implementation("org.http4k:http4k-core:6.6.0.1")
  implementation("org.http4k:http4k-server-jetty:6.6.0.1")
  implementation("org.http4k:http4k-format-moshi:6.6.0.1")
