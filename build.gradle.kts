...
dependencies {
  ...
  implementation("org.http4k:http4k-core:6.20.0.3")
  implementation("org.http4k:http4k-server-jetty:6.20.0.3")
  implementation("org.http4k:http4k-format-moshi:6.20.0.3")
