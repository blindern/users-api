...
dependencies {
  ...
  implementation("org.http4k:http4k-core:3.225.0")
  implementation("org.http4k:http4k-server-jetty:3.222.0")
  implementation("org.http4k:http4k-format-moshi:3.222.0")
