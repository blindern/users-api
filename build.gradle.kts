...
dependencies {
  ...
  implementation("org.http4k:http4k-server-jetty:3.268.0")
  implementation("org.http4k:http4k-format-moshi:3.268.0")
  ...
  testImplementation("org.amshove.kluent:kluent:1.62")
