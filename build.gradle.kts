...
dependencies {
  ...
  implementation("org.http4k:http4k-core:5.30.1.0")
  implementation("org.http4k:http4k-server-jetty:5.30.1.0")
  implementation("org.http4k:http4k-format-moshi:5.30.1.0")
