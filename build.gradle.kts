...
dependencies {
  ...
  implementation("org.http4k:http4k-core:4.33.2.1")
  implementation("org.http4k:http4k-server-jetty:4.33.2.1")
  implementation("org.http4k:http4k-format-moshi:4.33.2.1")
