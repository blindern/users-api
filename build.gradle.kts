...
dependencies {
  implementation("org.http4k:http4k-core:6.59.0.0")
  implementation("org.http4k:http4k-server-jetty:6.59.0.0")
  implementation("org.http4k:http4k-format-moshi:6.59.0.0")
